...
export const api = {
  ...
  adminUpdateCheck: (pin: string) => post<{ ok: boolean; behind: number; latestSha?: string; latestSubject?: string; latestAt?: string; subjects?: string[]; error?: string }>("/admin/update-check", { pin }),
